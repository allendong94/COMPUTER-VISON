...

{
    ...
    string Shrink[58] = { "001010000","100010000","000010100","000010001","000011000","010010000","000110000","000010010","101111111",
                          ...
                          "111110110","110110111","100111111","110110100","100110110","000111111","111011011","011011111","111111001",
                          "000110111","000011111","001011011","111011001","111110100","100110111","001011111","011011011","111111000",
                          "110110110","000110110","000011011","110011001","011110100","111011000","011011001","111110000","111111100",
                          "001111111","111011111","111111101","111110111" };
    string UShrink[320] = {"001010000","100010000",
                           "000010010","000011000",
                           "001011000","011010000","110010000","100110000","000110100","000010110","000010011","000011001",
                           "011110000","110011000","010011001","001011010",
                           "110110000","111111111",
                           "011010100","001011100","001110100","001110110","001010110",
                           "110010001","100110001","100011011","100010011","100011001",
                           "010111000","110111100","010111000","011111001","000111010","001111011","000111010","100111110",
                           "010110010","111110010","010110010","010110111","010011010","010011111","010011010","111011010",
    ...
    int total=size_r*size_c;int iter_count=0;
   bool sign=false;
    ...
    for(int j=1;j<size_c-1;j++)
      {
         ...
         {
          bound=2*(New[i+1][j]+New[i-1][j]+New[i][j+1]+New[i][j-1])+(New[i-1][j-1]+New[i-1][j+1]+New[i+1][j-1]+New[i+1][j+1]);
         if(bound==0||bound==12)
           {
             M[i][j] = 0;
           }
...
*/
    ...
    cout<<"the number of stars size is:"<<iter_count-1<<endl;
    ///////////////////////// END /////////////////////////
